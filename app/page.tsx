...
export default function Home() {
  return (
    <main className="min-h-screen">
      <Header />
      {/* Hero Section - First Impression with Fishing Photos */}
      <Hero />

      {/* Booking Calendar - Immediate Availability Check */}
      <BookingCalendar />

      {/* Pricing - Clear Pricing Information */}
      <Pricing />

      {/* Recent Blog - Latest Fishing Reports & News */}
      <RecentBlog />

      {/* Why Choose Us - Kairyumaru Features */}
      <WhyChooseUs />
